...
- To start the program, double-click the `start.bat` file. This will open three different command prompt windows. You can minimize these windows, but they must remain open for the program to function properly.

**Note**: The program could have been designed to run in a single shell, but it was separated for simplicity (laziness).